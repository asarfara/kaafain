      ...
      <div class="flex flex-wrap -mx-8">
        <div class="w-full lg:w-1/2 px-8">
          <div class="mb-12 lg:mb-0 pb-12 lg:pb-0 border-b lg:border-b-0">
            <h2 class="mb-4 text-3xl lg:text-4xl font-bold font-heading max-w-md">
        ...
        <div class="w-full lg:w-1/2 px-8">
          <ul class="space-y-12">
            <li class="flex -mx-4">
              ...
              <div class="px-4">
                <h3 class="my-4 text-xl font-semibold">Project Initialization</h3>
            ...
            <li class="flex -mx-4">
              ...
              <div class="px-4">
                <h3 class="my-4 text-xl font-semibold">Looking for Creative</h3>
                <p class="text-gray-400 leading-loose">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed luctus eget justo et iaculis.
                </p>
              </div>
            ...
            <li class="flex -mx-4">
              ...
              <div class="px-4">
                <h3 class="my-4 text-xl font-semibold">Market Development</h3>
                <p class="text-gray-400 leading-loose">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed luctus eget justo et iaculis.
                </p>
              </div>
